...
document.addEventListener('keydown', (e) => {
    ...
    if (e.altKey === toggleShortcut.altKey && e.ctrlKey === toggleShortcut.ctrlKey && e.shiftKey === toggleShortcut.shiftKey && e.key.toLowerCase() === toggleShortcut.key) { e.preventDefault(); e.stopPropagation(); if (errosGlobais.length > 0) painelAberto ? fecharPainel() : exibirPainel(); else revisarCampoAtualManualmente('manual-shortcut'); return; }
